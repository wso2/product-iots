...
public class AppManagerJmeterTestCase {
    ...
    @Test(description = "This test case tests Application Management")
    public void ApplicationManagementTest() throws AutomationFrameworkException {
        URL url = Thread.currentThread().getContextClassLoader()
                .getResource("jmeter-scripts" + File.separator + "ApplicationManagementAPI.jmx");
        JMeterTest script = new JMeterTest(new File(url.getPath()));
        JMeterTestManager manager = new JMeterTestManager();
