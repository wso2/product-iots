...
/**
 * This represents the raspberrypicodebased implementation of DeviceManagerService.
 */
public class DeviceTypeManager implements DeviceManager {
    ...
    public boolean enrollDevice(Device device) throws DeviceManagementException {
        ...
        try {
            if (log.isDebugEnabled()) {
                log.debug("Enrolling a new raspberrypicodebased device : " + device.getDeviceIdentifier());
            }
            ...
            String msg = "Error while enrolling the raspberrypicodebased device : " + device.getDeviceIdentifier();
            log.error(msg, e);
    ...
    public boolean modifyEnrollment(Device device) throws DeviceManagementException {
        ...
        try {
            if (log.isDebugEnabled()) {
                log.debug("Modifying the raspberrypicodebased device enrollment data");
            }
            DeviceTypeDAO.beginTransaction();
            ...
            String msg = "Error while updating the enrollment of the raspberrypicodebased device : " +
    ...
    public boolean disenrollDevice(DeviceIdentifier deviceId) throws DeviceManagementException {
        ...
        try {
            if (log.isDebugEnabled()) {
                log.debug("Dis-enrolling raspberrypicodebased device : " + deviceId);
            }
            DeviceTypeDAO.beginTransaction();
            ...
            String msg = "Error while removing the raspberrypicodebased device : " + deviceId.getId();
            log.error(msg, e);
            throw new DeviceManagementException(msg, e);
        }
        return status;
    ...
    public boolean isEnrolled(DeviceIdentifier deviceId) throws DeviceManagementException {
        ...
        try {
            if (log.isDebugEnabled()) {
                log.debug("Checking the enrollment of raspberrypicodebased device : " + deviceId.getId());
            }
            Device iotDevice =
            ...
            String msg = "Error while checking the enrollment status of raspberrypicodebased device : " +
                    deviceId.getId();
            log.error(msg, e);
            throw new DeviceManagementException(msg, e);
        }
    ...
    public Device getDevice(DeviceIdentifier deviceId) throws DeviceManagementException {
        ...
        try {
            if (log.isDebugEnabled()) {
                log.debug("Getting the details of raspberrypicodebased device : " + deviceId.getId());
            }
            device = deviceTypeDAO.getDeviceTypeDAO().getDevice(deviceId.getId());
        } catch (DeviceMgtPluginException e) {
            String msg = "Error while fetching the raspberrypicodebased device : " + deviceId.getId();
            log.error(msg, e);
            throw new DeviceManagementException(msg, e);
        }
        return device;
    ...
    public boolean updateDeviceInfo(DeviceIdentifier deviceIdentifier, Device device) throws DeviceManagementException {
        ...
        try {
            if (log.isDebugEnabled()) {
                log.debug("updating the details of raspberrypicodebased device : " + deviceIdentifier);
            }
            DeviceTypeDAO.beginTransaction();
            status = deviceTypeDAO.getDeviceTypeDAO().updateDevice(device);
            DeviceTypeDAO.commitTransaction();
            ...
            String msg =
                    "Error while updating the raspberrypicodebased device : " + deviceIdentifier;
            log.error(msg, e);
            throw new DeviceManagementException(msg, e);
        }
        return status;
    ...
    public List<Device> getAllDevices() throws DeviceManagementException {
        ...
        try {
            if (log.isDebugEnabled()) {
                log.debug("Fetching the details of all raspberrypicodebased devices");
            }
            devices = deviceTypeDAO.getDeviceTypeDAO().getAllDevices();
        } catch (DeviceMgtPluginException e) {
            String msg = "Error while fetching all raspberrypicodebased devices.";
            log.error(msg, e);
            throw new DeviceManagementException(msg, e);
        }
        return devices;
