...
public class DeviceTypeServiceImpl implements DeviceTypeService {
    ...
    public Response changeStatus(@PathParam("deviceId") String deviceId,
        ...
        try {
            ...
            deviceIdentifiers.add(new DeviceIdentifier(deviceId, "raspberrypicodebased"));
            APIUtil.getDeviceManagementService().addOperation("raspberrypicodebased", commandOp,
                    deviceIdentifiers);
