...
SENSOR_STATS = '{{"event":{{"metaData":{{"owner":"' + DEVICE_OWNER + '","deviceType":"' + DEVICE_TYPE \
                       + '","deviceId":"'+DEVICE_ID+'","time":{}}},"payloadData":{{"latitude":{}, "longitude":{}, ' \
                        '"type":"{}", "speed":{},"heading":{}, "state":"{}", "information":"{}","notify":{} }}}}}}'
...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
#       This method generate a random values
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
def generateRandomValues(valueFrom, valueTo):
    return random.uniform(valueFrom, valueTo)

def generateLatitudeLongitudeValue(num_rows):
    global INIT_LATITUDE
    global INIT_LONGITUDE
    for _ in xrange(1):
        dec_lat = random.random()/1000
        dec_lon = random.random()/1000
        INIT_LATITUDE = INIT_LATITUDE+dec_lat
        INIT_LONGITUDE = INIT_LONGITUDE+dec_lon
    return INIT_LONGITUDE, INIT_LATITUDE
