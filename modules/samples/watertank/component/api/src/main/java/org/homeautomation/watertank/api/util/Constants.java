...
public class Constants {
    ...
    public static final String DEFAULT_PERMISSION_RESOURCE = "/permission/admin/device-mgt/watertank/user";
    public static final String DEFAULT_ROLE_NAME = "watertank_user";
