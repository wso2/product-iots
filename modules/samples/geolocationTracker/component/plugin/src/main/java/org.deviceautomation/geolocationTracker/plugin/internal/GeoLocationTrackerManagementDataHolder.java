...
/**
 * DataHolder class of geolocationTracker plugins component.
 */
public class GeoLocationTrackerManagementDataHolder {

    private static GeoLocationTrackerManagementDataHolder thisInstance = new GeoLocationTrackerManagementDataHolder();
    private DeviceTypeConfigService deviceTypeConfigService;

    private GeoLocationTrackerManagementDataHolder() {
    }

    public static GeoLocationTrackerManagementDataHolder getInstance() {
        return thisInstance;
    }
