 ...
 */
package org.deviceautomation.geolocationTracker.plugin.impl.feature;
 ...
 */
public class GeoLocationTrackerFeatureManager implements FeatureManager {
	@Override
	...
	public Feature getFeature(String name) throws DeviceManagementException {
		...
		return genericFeatureManager.getFeature(GeoLocationTrackerConstants.DEVICE_TYPE, name);
	}

	@Override
	public List<Feature> getFeatures() throws DeviceManagementException {
		GenericFeatureManager genericFeatureManager = GenericFeatureManager.getInstance();
		return genericFeatureManager.getFeatures(GeoLocationTrackerConstants.DEVICE_TYPE);
	}
