...
def on_message(mqttClient, userdata, msg):
    ...
    iotUtils.VEHICLE_TYPE = str(msg.payload);
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
#       The callback for when a PUBLISH message to the server when door is open or close
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
def on_publish(mqttClient, streamPlayLoad):
    mqttClient.publish(TOPIC_TO_PUBLISH_STREAM, streamPlayLoad)

def sendSensorValue(streamPlayLoad):
    global mqttClient
    on_publish(mqttClient,streamPlayLoad)
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
def main():
    ...
    global TOPIC_TO_PUBLISH_STREAM
    TOPIC_TO_PUBLISH_STREAM = TANENT_DOMAIN + "/" + DEV_TYPE + "/" + DEV_ID + "/geolocation"
