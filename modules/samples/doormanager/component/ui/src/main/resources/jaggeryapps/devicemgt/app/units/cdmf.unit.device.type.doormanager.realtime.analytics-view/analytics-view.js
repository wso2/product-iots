...
function onRequest(context) {
    ...
    var websocketEndpointForStream1 = websocketEndpoint + "/secured-outputui/org.wso2.iot.devices.smartLock/1.0.0?"
        + "token=" + token + "&deviceId=" + device.deviceIdentifier + "&deviceType=" + device.type;
    var websocketEndpointForStream2 = websocketEndpoint + "/secured-outputui/org.wso2.iot.devices.smartFan/1.0.0?"
        + "token=" + token + "&deviceId=" + device.deviceIdentifier + "&deviceType=" + device.type;
    return {
        "device": device,
