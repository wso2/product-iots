...
public class DoorManagerDeviceMgtPluginException extends Exception {
    ...
    public DoorManagerDeviceMgtPluginException(String message, Throwable cause) {
        super(message, cause);
        setErrorMessage(message);
    }

    public DoorManagerDeviceMgtPluginException(String msg) {
        super(msg);
        setErrorMessage(msg);
    }

    public DoorManagerDeviceMgtPluginException() {
        super();
    }
