...
import org.wso2.connectedlap.api.DeviceTypeServiceImpl;
...
import org.wso2.connectedlap.plugin.impl.ConnectedLapDataManagerService;
import org.wso2.connectedlap.plugin.impl.DataManagerService;
...
public class APIUtil {
    ...
    //TODO: do changes
    public static ConnectedLapDataManagerService getDeviceDataManagerService() {
        PrivilegedCarbonContext ctx = PrivilegedCarbonContext.getThreadLocalCarbonContext();
        ConnectedLapDataManagerService dataManagerService =
                (ConnectedLapDataManagerService)ctx.getOSGiService(DataManagerService.class, null);
        if (dataManagerService == null) {
            String msg = "Device Data Management service has not initialized";
            log.error(msg);
            throw new IllegalStateException(msg);
        }
