...
import org.wso2.connectedlap.plugin.impl.util.DeviceTypeStartupListener;
...
import org.wso2.connectedlap.plugin.impl.DeviceTypeManagerService;
...
/**
 * @scr.component name="org.wso2.connectedlap.plugin.internal.ServiceComponent"
 * immediate="true"
    ...
    protected void activate(ComponentContext ctx) {
        ...
        try {
            ...
            bundleContext.registerService(ServerStartupObserver.class.getName(), new DeviceTypeStartupListener(),
                    null);
            bundleContext.registerService(DataManagerService.class.getName(), new ConnectedLapDataManagerService(),
                    null);
